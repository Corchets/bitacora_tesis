...
| 2026-09-23 | Argentina.gob.ar, BCRA, ANSES, MPF/UFECRI y Banco Galicia | `site:argentina.gob.ar estafa whatsapp codigo verificacion llamada`; `site:bcra.gob.ar premios datos telefonicos estafas`; `site:anses.gob.ar linea 130 consultas tramites` y verificación directa de las URL del catálogo | búsqueda dirigida, no exhaustiva | fuentes complementarias verificadas | Mateo Antenucci, revisión cruzada asistida | #17: código de WhatsApp por SMS, premio por llamada y canal ANSES iniciado por la persona. Afirmaciones y límites por fila en [CATALOGO-ESCENARIOS.csv](../datos-etica/CATALOGO-ESCENARIOS.csv); no se infiere prevalencia. |
| 2026-09-25 | fiscales.gob.ar y mpf.gob.ar (UFECI) | `UFECI fiscales.gob.ar estafas telefónicas llamadas modalidades`; `UFECI ciberdelincuencia informe estafas telefónicas vishing Argentina` | 10 + 10 | 4 | Corchets, búsqueda asistida | #26: informe anual 2024, informe de pandemia (datos 2020), capacitación UFECI–WhatsApp y alerta de obtención de datos bajo engaño. Tres por llamada; la alerta de 2019 es por WhatsApp y web, fuera de la tipología. Extracción en [TIPOLOGIA-MANIOBRAS-VISHING.md §6.1](TIPOLOGIA-MANIOBRAS-VISHING.md#61-fuentes-de-la-ufeci). Se descartó una cifra de prensa sobre vishing que no se encontró en la fuente primaria. |
| 2026-09-25 | buenosaires.gob.ar y argentina.gob.ar (Min. Seguridad) | `Policía de la Ciudad Buenos Aires estafas telefónicas falso policía secuestro virtual recomendaciones`; `"Policía de la Ciudad" advierte llamadas falsos policías cuentos del tío secuestro virtual`; `Ministerio de Seguridad argentina.gob.ar secuestro virtual llamada qué hacer` | 10 + 10 + 10 | 3 | Corchets, búsqueda asistida | #26: secuestro virtual por llamada documentado (2014–2020); ninguna menciona falso policía. Se excluyeron prensa y fuentes de otros países. Extracción en [TIPOLOGIA-MANIOBRAS-VISHING.md §6.2](TIPOLOGIA-MANIOBRAS-VISHING.md#62-policía-de-la-ciudad-y-ministerio-de-seguridad). |
| 2026-09-25 | Literatura de persuasión (deep research + cotejo manual) | Fuentes objetivo: Jones et al. 2021 (ICS 29(2)), Stajano y Wilson 2011 (CACM 54(3)), Ferreira et al. 2015 (LNCS 9190), Cialdini | 7 propuestas | 2 verificadas | Corchets | #26: el deep research devolvió 2 fuentes inexistentes, 1 con citas que no figuran en el texto y varias páginas sin verificar. Solo se incorporaron las citas leídas en el PDF. Descartes documentados en [TIPOLOGIA-MANIOBRAS-VISHING.md §5.3](TIPOLOGIA-MANIOBRAS-VISHING.md#53-fuentes-descartadas-del-deep-research). |
