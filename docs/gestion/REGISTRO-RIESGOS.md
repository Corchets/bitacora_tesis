...
| R08 | Modelo demasiado pesado para móvil | 3 | 3 | real-time factor >1 o memoria excesiva | techos 256/512/1024 MB y 2/4/6 hilos; ASR baja = Moonshine tiny-es (27 M); baseline TF–IDF; fallback DistilBETO | ejecutar detector clásico; no afirmar on-device si solo se midió alta | por autoasignar | abierto |
